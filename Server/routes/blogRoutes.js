...
const {PostBlog,getBlog,getALLBlogs,getUserBlogs,MakeBlogComment,getBlogComment} = require('../controllers/blog')
...
router.get('/getUserBlogs/:blogId',verifyToken,getBlogComment)
